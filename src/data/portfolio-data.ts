...
export const projects: Project[] = [
  ...
  {
    title: 'Checkpoint POS',
    description: 'Sistem manajemen operasional lengkap untuk Checkpoint Cafe — menyatukan admin, kasir, menu, inventaris, dan keuangan dalam satu platform all-in-one.',
    icon: 'Printer',
    colorClass: 'bg-zinc-600/20',
    gradientClass: 'from-zinc-500 via-zinc-600 to-zinc-700',
    status: 'Live',
    techStack: ['PHP', 'MySQL', 'Tailwind', 'JavaScript', 'PWA', 'Docker'],
    techColorClass: 'bg-white/[0.03] border border-white/[0.08] text-text-secondary',
    demoUrl: 'https://cekpoint.store',
    githubUrl: 'https://github.com/dimsdevv/beanpay-pos',
    image: '/logo.jpeg',
    category: 'web',
    highlights: [
      'Dashboard admin — ringkasan penjualan, stok menipis, dan aktivitas harian dalam satu layar.',
      'Sistem kasir — interface cepat untuk input pesanan, pembayaran, dan cetak struk.',
      'Manajemen menu & kategori — tambah, edit, dan atur harga menu dalam hitungan detik.',
      'Inventaris bahan baku — lacak stok masuk/keluar, peringatan otomatis saat stok menipis.',
      'Administrasi keuangan — catat pemasukan, pengeluaran, dan lihat laporan laba-rugi harian.',
    ],
    challenge: 'Checkpoint Cafe terletak di komplek perumahan baru yang masih berkembang, tidak jauh dari garis pantai dan jalur touring favorit pesepeda serta pengendara liburan. Pola pengunjung sangat fluktuatif — ramai di akhir pekan dan musim liburan, lengang di hari biasa. Sistem manual sebelumnya membuat pemilik cafe kesulitan memprediksi kebutuhan stok, sering kehabisan bahan di jam sibuk atau justru kelebihan stok yang terbuang. Keputusan bisnis diambil berdasarkan perkiraan, bukan data nyata.',
    solution: 'Checkpoint POS dibangun sebagai sistem all-in-one yang menyatukan dashboard admin, kasir, manajemen menu, inventaris, dan laporan keuangan dalam satu platform. Dengan arsitektur ringan berbasis PHP + Tailwind CSS, sistem bisa diakses dari perangkat apa pun di cafe tanpa perlu hardware khusus. Laporan real-time memberi pemilik cafe visibilitas penuh terhadap pola penjualan — dari menu terlaris hingga tren stok — sehingga keputusan stok dan menu bisa disesuaikan dengan siklus pengunjung yang dinamis. PWA memungkinkan akses offline untuk kasir saat koneksi internet tidak stabil.',
  },
  {
...
export const experiences: Experience[] = [
  {
    ...
    responsibilities: [
      ...
      'Mempelajari secara langsung bagaimana mengelola sistem bisnis dan operasional cafe secara profesional.',
    ],
  ...
  },
  {
    ...
    techStack: ['HTML', 'PHP', 'Tailwind CSS', 'MySQL'],
    responsibilities: [
      'Membangun website Wakaf Al-Quran — platform donasi online untuk pengelolaan wakaf dan penyaluran.',
      'Mendesain UI yang responsif menggunakan Tailwind CSS agar nyaman diakses dari perangkat apapun.',
      'Mengembangkan backend PHP + MySQL untuk manajemen data donatur, riwayat wakaf, dan laporan.',
      'Berkolaborasi dengan staf pesantren untuk memahami kebutuhan operasional dan menerjemahkannya ke fitur web.',
    ],
  ...
  },
  {
    ...
    description: 'Menempuh studi Sistem Informasi, fokus pada arsitektur sistem dan data',
    year: '2025 — Sekarang',
    icon: 'GraduationCap',
    ...
    techStack: [],
    responsibilities: [
      'Mengambil mata kuliah inti: Software Engineering, Database Systems, Data Structures & Algorithms.',
      'Mengerjakan proyek-proyek berbasis web — dari perancangan database, backend API, hingga antarmuka responsif.',
      'Mempelajari analisis data menggunakan Python (Pandas, NumPy, Matplotlib) pada dataset real.',
      'Membangun portofolio personal secara konsisten dengan proyek-proyek yang menyelesaikan masalah nyata.',
    ],
