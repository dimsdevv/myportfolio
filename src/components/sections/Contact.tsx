      ...
      <div className="grid lg:grid-cols-2 gap-16">
        <div className="reveal-left">
          ...
          <div className="space-y-4 mb-10">
            <a href="mailto:dmscmail0@gmail.com" className="flex items-center gap-4 glass-card rounded-2xl p-4 group hover:border-white/[0.12] transition-colors">
            ...
            <a href="https://www.linkedin.com/in/dimassholihulhadi" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 glass-card rounded-2xl p-4 group hover:border-white/[0.12] transition-colors">
              <div className="w-10 h-10 rounded-xl bg-white/[0.06] flex items-center justify-center text-text-secondary flex-shrink-0 group-hover:bg-white/[0.1] transition-colors">
            ...
            <a href="https://github.com/dimsdevv" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 glass-card rounded-2xl p-4 group hover:border-white/[0.12] transition-colors">
              <div className="w-10 h-10 rounded-xl bg-white/[0.06] flex items-center justify-center text-text-secondary flex-shrink-0 group-hover:bg-white/[0.1] transition-colors">
